...
const IconUnlock = React.forwardRef(function IconUnlock(
  ...
  return (
    <SvgIcon {...props} ref={ref}>
      <path d="M4.7 8a.67.67 0 0 1-.5-.22.76.76 0 0 1-.2-.52v-2.8a4.51 4.51 0 0 1 1.1-3.14 3.79 3.79 0 0 1 5.8 0A4.3 4.3 0 0 1 12 4.47c0 .2-.08.38-.2.52a.67.67 0 0 1-.5.21.67.67 0 0 1-.48-.21.76.76 0 0 1-.2-.52 2.95 2.95 0 0 0-.72-2.08 2.48 2.48 0 0 0-3.81 0 2.82 2.82 0 0 0-.7 2.08v2.8c0 .19-.08.37-.2.51a.68.68 0 0 1-.5.22Z" />
